...
const lut_t lut_0_10_4[LUT_SIZE] = { 
...
lut_t lut_lookup_0_10_4(lut_input_t input) {
  #pragma HLS BIND_STORAGE variable=lut_0_10_4 type=RAM_1P impl=LUTRAM
  return lut_0_10_4[value_to_index(input)];
}