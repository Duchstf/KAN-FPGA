...
sys.path.append('../../src')
from KAN_OG_InputQuant import KAN

ENV_ID = "HalfCheetah-v5"
TOTAL_TIMESTEPS = 1_000_000
LOG_DIR = "logs_kan_float_with_inputquant"
...
class KANAsActorExtractor(nn.Module):
    ...
    def __init__(self, feature_dim: int, action_dim: int, critic_layers=(64, 64), kan_kwargs=None):
        ...
        self.policy_net = KAN([feature_dim, action_dim], input_layer, **kan_kwargs)
