...
__attribute__((sdx_kernel("add5_sat_ufixed", 0))) ap_uint<2> add5_sat_ufixed(ap_uint<2> a, ap_uint<2> b, ap_uint<2> c,
                           ap_uint<2> d, ap_uint<2> e) {
#line 20 "/data/dhoang/test/KAN-FPGA/atest/run_hls.tcl"
#pragma HLSDIRECTIVE TOP name=add5_sat_ufixed
# 16 "dut.cpp"

#pragma HLS INLINE

 ap_ufixed<2,2, AP_TRN, AP_SAT> sat = a + b + c + d + e;
