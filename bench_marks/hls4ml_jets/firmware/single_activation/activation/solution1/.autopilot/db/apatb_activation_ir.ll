...
define void @apatb_activation_ir(float %input, float* noalias nocapture nonnull dereferenceable(4) %output) local_unnamed_addr #0 {
entry:
  %output_copy = alloca float, align 512
  call fastcc void @copy_in(float* nonnull %output, float* nonnull align 512 %output_copy)
  call void @apatb_activation_hw(float %input, float* %output_copy)
  call void @copy_back(float* %output, float* %output_copy)
  ret void
}
...
declare void @apatb_activation_hw(float, float*)
...
define void @activation_hw_stub_wrapper(float, float*) #4 {
entry:
  call void @copy_out(float* null, float* %1)
  call void @activation_hw_stub(float %0, float* %1)
  call void @copy_in(float* null, float* %1)
  ret void
}

declare void @activation_hw_stub(float, float*)
